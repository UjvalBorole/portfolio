      ...
      <div className="mx-auto w-full max-w-screen-xl p-4 py-3 lg:py-3">
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex mt-2 space-x-5 sm:justify-center sm:mt-0">
            <Link to="https://leetcode.com/boroleujval4/" className="text-gray-500 hover:text-gray-900">
              <svg
                className="w-5 h-5"
                aria-hidden="true"
                viewBox="0 0 24 24"
            ...
            <Link to="https://auth.geeksforgeeks.org/user/zaccode" className="text-gray-500">
              <svg
                className="w-5 h-5"
                aria-hidden="true"
                fill="currentColor"
            ...
            <Link to="https://www.naukri.com/mnjuser/profile" className="text-gray-500">
              <svg
                className="w-4 h-4"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
              ...
              <span className="sr-only">Nokari.com</span>
            </Link>
          </div>
        </div>
      </div>
